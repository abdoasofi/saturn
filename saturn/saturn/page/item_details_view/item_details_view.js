...
function render_page_layout(page, company_info) {
    ...
    const page_html = `
        <style>
            /* All previous styles are still valid and good */
            ...
            .search-card { padding: 1.5rem; background-color: #fff; border-radius: var(--border-radius); border: 1px solid var(--border-color); margin-bottom: 25px; text-align: center; }
            ...
            .stock-levels-card { margin-top: 25px; } /* Spacing for the new card */
        ...
        <div class="item-viewer-wrapper" dir="${is_rtl ? 'rtl' : 'ltr'}">
            <!-- Header and Search card remain the same -->
            ...
            <div id="item-details-section" style="display: none;">
                <div class="item-details-grid">
                    ...
                    <!-- COLUMN 1: Main Details + Stock Levels -->
                    ...
                    <!-- COLUMN 2: Side Details (Image and QR) -->
...
// --- NO CHANGES NEEDED IN ANY OTHER FUNCTION ---
// The functions below are just for completeness.
